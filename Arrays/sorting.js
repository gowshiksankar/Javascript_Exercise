...
console.log(numbers);
numbers.reverse()  //It reverse the element
console.log(numbers);   //Output : [ 1, 2, 3, 5, 7, 10 ]


// Split function

let a1 = "hello world"
console.log(a1.split()) //Output: [ 'hello world' ]
console.log(a1.split(""))   //output: [ 'h', 'e', 'l', 'l', 'o', ' ', 'w', 'o', 'r', 'l', 'd']
console.log(a1.split(" "))  //output: [ 'hello', 'world' ]